...
const Accelerate = () => {
    return (
        <div className="min-h-screen hidden w-full px-32 py-40 lg:flex flex-col items-center justify-center gap-10 dark:bg-black">
            ...
            <div className="flex w-full lg:w-[65%] border border-white/50 rounded-full">
            ...
            <div className="flex gap-10 items-center">
                <button className="flex gap-5 items-center text-2xl font-medium py-4 px-8 rounded-full border border-white">
